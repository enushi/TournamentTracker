...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            // C:\Users\EN\Desktop\C#Practice\dataText\PrizeModles.csv
        ...
        {
        //id, team name, list of id's separated by pipe
        ...
        foreach (string line in lines)
        {
            ...
            {
                t.TeamMembers.Add(people.Where(x => x.Id == Int32.Parse(id)).First());
            }
        ...
        foreach (List<MatchupModel> round in model.Rounds)
        {
            ...
            {
                    // Load all of matchups from file
                    // Get the top id add one
                    // Store the id
        ...
        public static void SaveMatchupToFile(this MatchupModel matchup)
        {
         ...
         //    .FullFilePath()
         //    .LoadFile()
         //    .ConvertToTournamentsModel(TeamsFile, PeopleFile, PrizesFile);
        ...
        public static void SaveToTournamentFile(this List<TournamentModel> models)
        {
            ...
            {
                lines.Add($"{tm.Id},{tm.TournamentName},{tm.EntryFee},{ConvertTeamListToString(tm.EnteredTeams)},{ConvertToPrizeListToString(tm.Prizes)},{ConvertRoundsListToString(tm.Rounds)}");
            }
